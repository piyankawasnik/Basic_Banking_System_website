...
$v1=$_SESSION['acno'];
  ...
  {
       echo("<tr><td> ACNo</td><td>".$row[0]."</td></tr><tr><td> Name </td><td>".$row[2]."</td>
       </tr><tr><td>Address </td><td>".$row[3]."</td></tr><tr><td>MobileNo </td><td>".$row[4]."</td></tr><tr><td>eMail </td><td>".$row[5]."</td></tr><tr><td>actype </td><td>".$row[6]."</td></tr>");
   }
?>
</table>
